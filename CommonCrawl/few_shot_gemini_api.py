...
def main():
    ...
    unlabel_file = r"H:\我的雲端硬碟\RelationExtration\CommonCrawl\data\test\few_shot.json"
    ...
    output_file_path = r"H:\我的雲端硬碟\RelationExtration\CommonCrawl\data\test\few_shot.csv"
...
def check_format(input_string):
    try:
        if "Relations:無" in  input_string:
            return True
        if "Relations:有" in input_string:
            pattern = r'\((.*?)\)'
